...
-- ACTIONS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping("Bank","Abrir Banco","keyboard","E")
RegisterKeyMapping("Barbershop","Abrir Barbearia","keyboard","E")
RegisterKeyMapping("Crafting","Abrir Crafting","keyboard","E")
RegisterKeyMapping("Doors","Abrir/Fechar Portas","keyboard","E")
RegisterKeyMapping("Mechanic","Abrir Mecânica","keyboard","E")
RegisterKeyMapping("Teleport","Teleportar para o local marcado","keyboard","E")
RegisterKeyMapping("Services","Entrar/Sair do Serviço","keyboard","E")
RegisterKeyMapping("Shops","Abrir Loja","keyboard","E")
RegisterKeyMapping("Skinshop","Abrir Loja de Roupas","keyboard","E")
RegisterKeyMapping("Tattooshop","Abrir Loja de Tatuagem","keyboard","E")
-----------------------------------------------------------------------------------------------------------------------------------------
-- KEYMAPPING
-----------------------------------------------------------------------------------------------------------------------------------------
