...
Config.Controls = {}
Config.Command = 'x'
Config.Controls.Stop = 'F6'
Config.Controls.SpeedUp = 'PAGEUP'
Config.Controls.SpeedDown = 'PAGEDOWN'
...
function IsAlive(playerPed)
    return (GetEntityHealth(playerPed) > 100)
end

function PedCheck(playerPed)
...
function CheckAnimFlag(index, flag)
    return _ANIM[index].flags[flag]
end

function Anim(playerPed, animDict, animName, duration, flag)
    LoadAnimDict(animDict)
    PlayAnim(playerPed, animDict, animName, duration, flag)
    UnloadAnimDict(animDict)
end

function AnimExit(playerPed, animDict, animName)
    LoadAnimDict(animDict)
...
function Scene(playerPed, animDict, anim1, anim2, anim3, anim4)
...
function SceneExit(playerPed, animDict, anim1, anim2)
    local duration = GetDuration(animDict, anim1)
    PlayAnim(playerPed, animDict, anim1)
    Wait(duration-350)
    duration = GetDuration(animDict, anim2)
...
function Anim_V06_2(playerPed, p1)
    local animDict = 'oddjobs@assassinate@vice@sex'
    local suffix   = (p1 == true and 'm' or 'f')
...
RegisterKeyMapping('+randallsmx', _s('keymapping_hint'), 'keyboard', Config.Controls.Stop)
RegisterCommand('+randallsmx', function()
    if ANIMS:IsPlayingAnim() then ANIMS:Stop(true) end
end)

RegisterKeyMapping('+randallsmxsup', _s('keymapping_hint_3'), 'keyboard', Config.Controls.SpeedUp)
RegisterCommand('+randallsmxsup', function() ANIMS:ChangeSpeed(true) end)

RegisterKeyMapping('+randallsmxsdown', _s('keymapping_hint_4'), 'keyboard', Config.Controls.SpeedDown)
