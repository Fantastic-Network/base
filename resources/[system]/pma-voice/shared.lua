...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{2.0, "Susurrando"}, -- Whisper speech distance in gta distance units
		{5.3, "Normal"}, -- Normal speech distance in gta distance units
		{20.0, "Gritando"}, -- Shout speech distance in gta distance units
		-- {99999.0, "Admin Speech"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{2.0, "Susurrando"}, -- Whisper speech distance in gta distance units
